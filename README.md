...
**Full Stack Developer | BCA Graduate | Meerut, UP, India**
...
- 🎓 **BCA Graduate** from Meerut, Uttar Pradesh
...
![bcrypt](https://img.shields.io/badge/bcrypt-338?style=for-the-badge&logo=lock&logoColor=white)
...
| [📱 Apple iPhone Clone](https://github.com/Dpnxhuu/apple-iphone15-landing-page) | iPhone 15 Pro landing page with GSAP & 3D model | React, GSAP, Three.js |
| [🌦️ Weather App](https://github.com/Dpnxhuu/weather-app-react) | Responsive weather dashboard using live weather API | React, Tailwind |
| [🔍 GitHub User Search](https://github.com/Dpnxhuu/github-user-search) | Search & view GitHub profiles in real time | React |

---

## 🎯 Currently Focused On

- 🔨 Building full stack projects with **Next.js + MySQL + JWT**
- 🌐 Deploying production apps on **Vercel + Railway**
